...
*/
//string S[n]=0;
//for(int i=0; i<n; i++){S[0]=S[0]+i;} // IcI je cherche un moyen de faire toutes les possibilité de chemin entre les mpoint mais il faut les enregistrer quelque part pour l'instant je bloque
//cout<<S[0];
//combinaison(S,0,n);
